    ...
    <Layout>
        ...
        <BRow>
            <BCol xxl="6">
                ...
                <BCard no-body>
                    <BCardBody class="vertical-navtab">
                        <p class="text-muted">Use <code>flex-column</code> class to create Vertical nav tabs.</p>
                        <BRow>
                            <BTabs navClass="flex-md-column text-center" navWrapperClass="col-md-3" contentClass="text-muted mt-4 mt-md-0 col-md-9" pills vertical justified>
                                <BTab title="Home" active>
                ...
                <BCard no-body>
                    ...
                    <BCardBody>
                        ...
                        <BTabs nav-class="nav-tabs-custom rounded card-header-tabs border-bottom-0 text-muted tamp pt-2">
                            ...
                            <BTab title="Profile">
                                <p class="me-3 mb-0">
                                    <img src="@assets/images/users/avatar-3.jpg" alt="" class="avatar-lg rounded float-end ms-3"> Experiment and play around with the
                            ...
                            <BTab title="Message">
                                <p class="ms-3 mb-0">
                                    <img src="@assets/images/users/avatar-5.jpg" alt="" class="avatar-lg rounded float-start me-3">Trust fund seitan letterpress, keytar
                        ...
                        <BTabs nav-class="arrow-navtabs nav-success bg-light mb-3" content-class="text-muted" pills>
                            ...
                            <BTab title="Profile">
                                ...
                                <p class="mb-0">
                                    ...
                                    unusual, and that’s why using contrasting colors in <BLink href="#" class="text-decoration-underline"><b>Graphic Design</b></BLink> is a must. It’s
                            ...
                            <BTab>
                                ...
                                <p class="mb-0">
                                    ...
                                    which is excellent news to the beginner and advanced <BLink href="#" class="text-decoration-underline"><b>Contact Designer</b></BLink>.
                                </p>
                            </BTab>
                        </BTabs>
                    </BCardBody>
            ...
            <BCol xxl="6">
                ...
                <BCard no-body style="position: relative;">
                    ...
                    <BCardBody>
                        ...
                        <BTabs nav-class="card-header-pills text-muted tamp mt-4 mb-3 m-lg-0" pills>
                ...
                <BCard no-body>
                    <BCardBody>
                        <p class="text-muted">Use <code>card-footer-tabs</code> class to create the bottom card nav
                            justify tab.</p>
                        <BTabs nav-class="card-footer-tabs fs-17 text-muted" content-class="mb-3" nav-wrapper-class="card-footer bg-transparent border-top pb-0" pills justified end>
                            <BTab>
        ...
        <BRow>
            ...
            <BCol xxl="6">
                ...
                <BCard no-body>
                    <BCardBody class="custom-vertical-tab">
                        <p class="text-muted">Use <code>custom-verti-nav-pills</code> class to create custom vertical
                            tabs.</p>
                        <BRow>
                            <BTabs navClass="custom-verti-nav-pills text-center" navWrapperClass="col-md-3" contentClass="text-muted mt-3 mt-lg-0 col-md-9" pills vertical justified>
                                <BTab active class="row">
                                    <template #title>
                            ...
                            <BTab title="Home">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1 ms-2">
                                        ...
                                        Cred vinyl keffiyeh DIY salvia PBR.
                                        <div class="mt-2">
                                            <BLink href="#" class="btn btn-link">Read More <i class="ri-arrow-right-line ms-1 align-middle"></i></BLink>
                                        </div>
                                    </div>
                    ...
                    <BCardBody>
                        ...
                        <BTabs nav-class="nav-tabs nav-justified nav-border-top nav-border-top-success mb-3 text-muted">
                            ...
                            <BTab class="nav-item">
                                ...
                                <p class="mb-0">
                                    Opposites attract, and that’s a fact. It’s in our nature to be interested in the
                                    uBLink usual, and that’s why using contrasting colors in <BLink href="javascript:void(0);" class="text-decoration-underline"><b>Graphic
                            ...
                            <BTab class="nav-item">
                                ...
                                <p class="mb-0">
                                    ...
                                    over the years, which is excellent news to the beginner and advanced <BLink href="javascript:void(0);" class="text-decoration-underline"><b>Contact
                                            Designer</b></BLink>.
                                </p>
                            </BTab>
                        </BTabs>
...
@media (max-width: 425px) {
    .vertical-navtab,.custom-vertical-tab{
        .tabs{
