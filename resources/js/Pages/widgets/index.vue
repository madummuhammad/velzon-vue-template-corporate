...
import liveUser from "../dashboards/analytics/country.vue";
                    ...
                    <div class="acitivity-item py-3 d-flex">
                      ...
                      <div class="flex-grow-1 ms-3">
                        <h6 class="mb-1">Today offers by
                          <Link href="/ecommerce/seller-details" class="link-secondary">
      ...
      <BCol xl="3" md="6">
        <BCard no-body class="card-height-100">
          <BCardHeader class="align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
              <BLink class="text-muted" href="javascript:void(0);">
                View All
              </BLink>
            </div>
          </BCardHeader>
          <BCardBody>
            <swiper class="swiper mySwiper product-swiper" :autoplay="false" :slidesPerView="2" :spaceBetween="30" :modules="[Autoplay]">
