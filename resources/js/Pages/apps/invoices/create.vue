...
export default {
    ...
    selectedv(val) {
      if (val) {
        ...
        for (var i = 1; i <= darray.length; i++) {
          if (darray[i - 1] == val) {
            var price = this.allproductdata[result].price;
            price = price.replace("$", "");
            price = price.replace(" ", "");
            document.getElementById('productprice' + i).value = price;
          }
        }
        this.productids.push(this.allproductdata[result].id);
      }
    },
    createinvoice() {
      var data = {
      ...
      Array.prototype.forEach.call(
        ...
        (item) => {
          item.addEventListener("keyup", (e) => {
            let priceselection = item.parentElement.nextElementSibling.nextElementSibling.querySelector(".product-line-price");
            let amount = e.target.value;
            let itemQuntity = item.parentElement.nextElementSibling.querySelector(".product-quantity").value;
  ...
  beforeMount() {
      this.allproductdata = productsData;
          ...
          <form class="needs-validation" novalidate>
              ...
              <BRow class="g-3">
                ...
                <BCol lg="3" sm="6">
                  <div>
                    ...
                    <flat-pickr v-model="date" id="invoicedate" placeholder="Select date and time" :config="config" class="form-control bg-light border-light border-0"></flat-pickr>
                  </div>
                </BCol>
                <BCol lg="3" sm="6">
                  <label for="choices-payment-status">Payment Status</label>
                  <div class="input-light">
                    <Multiselect class="form-control w-md" id="paymentstatus" v-model="paymentvalue" :close-on-select="true" :searchable="true" :create-option="true" :options="[
            ...
            <BCardBody class="p-4">
                ...
                <table class="invoice-table table table-borderless table-nowrap mb-0">
                    ...
                    <tr class="table-active">
                      ...
                      <th scope="col" style="width: 152px">
                        <div class="d-flex currency-select input-light align-items-center">
                          ...
                          <Multiselect class="bg-light" v-model="value1" :close-on-select="true" :searchable="true" :create-option="true" :options="[
                            { value: '$', label: '($)' },
                            { value: '£', label: '(£)' },
                            { value: '₹', label: '(₹)' },
                            { value: '€', label: '(€)' },
                  ...
                  <tbody id="newlink">
                    ...
                    <tr v-for="n in count" :key="n" :id="n" class="product">
                      ...
                      <td class="text-start">
                        <Multiselect class="form-control w-md" v-model="newproductvalue[n - 1]" :close-on-select="true" :searchable="true" :create-option="true" :options="products" @select="selectedv(newproductvalue[n - 1])" />
                      </td>
                      <td>
                        <input type="number" :id="'productprice' + n" class="form-control product-price bg-light border-0" placeholder="0.00" required />
                  ...
                  <tr>
                    <td colspan="9">
                      <BLink href="javascript:void(0)" @click="new_link" class="btn btn-soft-secondary fw-medium"><i class="ri-add-fill me-1 align-bottom"></i> Add
                        Item</BLink>
                    </td>
                  </tr>
              ...
              <BRow class="mt-3">
                <BCol lg="4">
                  <div class="mb-2">
                    ...
                    <div class="input-light">
                      <Multiselect class="form-control w-md" v-model="value" :close-on-select="true" :searchable="true" :create-option="true" :options="[
              ...
              <div class="hstack gap-2 justify-content-end d-print-none mt-4">
                ...
                <BLink href="javascript:void(0);" class="btn btn-primary"><i class="ri-download-2-line align-bottom me-1"></i> Download
                  Invoice</BLink>
                <BLink href="javascript:void(0);" class="btn btn-secondary"><i class="ri-send-plane-fill align-bottom me-1"></i> Send
                  Invoice</BLink>
              </div>
            </BCardBody>
          </form>
