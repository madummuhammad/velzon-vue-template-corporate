...
export default {
  ...
  methods: {
    ...
    deleteData() {
      if (this.event.id) {
        this.invoiceList = this.invoiceList.filter((item) => item.id != this.event.id);
                ...
                <table class="table align-middle table-nowrap" id="invoiceTable">
                  ...
                  <tbody class="list form-check-all">
                    <tr v-for="(item, index) of resultQuery" :key="index">
                      ...
                      <td>
                        <BDropdown variant="link" class="card-header-dropdown" toggle-class="btn btn-soft-secondary btn-sm arrow-none" menu-class="dropdown-menu-end" :offset="{ alignmentAxis: -130, crossAxis: 0, mainAxis: 10 }">
                          <template #button-content><i class="ri-more-fill align-middle"></i></template>
                          <Link class="dropdown-item" href="/invoices/detail"><i class="ri-eye-fill align-bottom me-2 text-muted"></i>View</Link>
                          <Link class="dropdown-item" href="/invoices/create"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i>Edit</Link>
