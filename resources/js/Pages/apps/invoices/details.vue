                ...
                <BCard no-body id="demo">
                        ...
                        <div class="d-sm-flex">
                            ...
                            <div class="flex-shrink-0 mt-sm-0 mt-3">
                                ...
                                <h6><span class="text-muted fw-normal">Website:</span>
                                    <BLink href="https://themesbrand.com/" class="link-primary" target="_blank" id="website">{{ website }}</BLink>
                                </h6>
                                <h6 class="mb-0"><span class="text-muted fw-normal">Contact No: </span><span id="contact-no">{{ contact }}</span></h6>
                            </div>
                        </div>
                    </BCardHeader>
                    <BCardBody class="p-4">
                        <BRow class="g-3">
                            ...
                            <BCol lg="3" cols="6">
                                ...
                                <h5 class="fs-14 mb-0"><span id="invoice-date">{{ date }}</span> <small class="text-muted" id="invoice-time">02:36PM</small></h5>
                            </BCol>
                            <BCol lg="3" cols="6">
                    ...
                    <BCardBody class="p-4">
                        ...
                        <div class="mt-3">
                            ...
                            <p class="text-muted mb-1">Payment Method: <span class="fw-medium" id="payment-method">{{ payment_method }}</span></p>
                            <p class="text-muted mb-1">Card Holder: <span class="fw-medium" id="card-holder-name">{{ card_holder_name }}</span></p>
                            <p class="text-muted mb-1">Card Number: <span class="fw-medium" id="card-number">{{ card_number }}</span>
                            </p>
                            <p class="text-muted">Total Amount: <span class="fw-medium" id="">$ </span>
                        ...
                        <div class="hstack gap-2 justify-content-end d-print-none mt-4">
                            <BLink href="javascript:window.print()" class="btn btn-secondary"><i class="ri-printer-line align-bottom me-1"></i> Print</BLink>
                            <BLink href="javascript:void(0);" class="btn btn-primary"><i class="ri-download-2-line align-bottom me-1"></i>
                                Download</BLink>
                        </div>
                    </BCardBody>
                </BCard>
