    ...
    <Layout>
                ...
                <BRow class="g-2">
                    <BCol lg="auto">
                        <div class="hstack gap-2">
                            <BButton variant="primary" @click="modalShow1 = !modalShow1"><i class="ri-add-line align-bottom me-1"></i> Create Board</BButton>
                        </div>
                    </BCol>
        ...
        <div class="tasks-board mb-3" id="kanbanboard">
            <div class="tasks-list">
                <div class="d-flex mb-3">
                    <div class="flex-grow-1">
                        <h6 class="fs-14 text-uppercase fw-semibold mb-0">Unassigned <BBadge tag="small" variant="success" class="align-bottom ms-1">2</BBadge>
                        </h6>
                    </div>
                    <div class="flex-shrink-0">
                        <BDropdown variant="link" class="card-header-dropdown" toggle-class="p-0 arrow-none" menu-class="dropdown-menu-end" :offset="{ alignmentAxis: -70, crossAxis: 0, mainAxis: 10 }">
                            <template #button-content><span class="fw-medium text-muted fs-12">Priority<i class="mdi mdi-chevron-down ms-1"></i></span></template>
                            ...
                            <BCard no-body class="tasks-box" v-for="(data, index) of unassigned" :key="index">
                                <BCardBody>
                                    <div class="d-flex mb-2">
                                        ...
                                        <BDropdown variant="link" toggle-class="text-muted p-0 arrow-none" :offset="{ alignmentAxis: -130, crossAxis: 0, mainAxis: 10 }">
                                            <template #button-content><i class="ri-more-fill "></i></template>
                                            <Link class="dropdown-item" href="/apps/tasks-details"><i class="ri-eye-fill align-bottom me-2 text-muted"></i>
                                                View</Link>
                                            <BDropdownItem><i class="ri-edit-2-line align-bottom me-2 text-muted"></i>
                                                Edit </BDropdownItem>
                                            <BDropdownItem @click="deleteTask"> <i class="ri-delete-bin-fill align-bottom me-2 text-muted"></i>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="flex-grow-1">
                                            <BBadge variant="primary-subtle" class="bg-primary-subtle text-primary me-1" v-for="(item, index) of data.features" :key="index">{{ item }}</BBadge>
                                        </div>
                                        <div class="flex-shrink-0">
                                            <div class="avatar-group">
                                                <BLink href="javascript: void(0);" v-for="(item, index) of data.users" :key="index" class="avatar-group-item" v-b-tooltip.hover title="Alexis">
                                        ...
                                        <div class="flex-shrink-0">
                                            <ul class="link-inline mb-0">
                                                <li class="list-inline-item">
                                                    <BLink href="javascript:void(0)" class="text-muted"><i class="ri-eye-line align-bottom"></i> 04</BLink>
                                                </li>
                                                <li class="list-inline-item">
                                                    <BLink href="javascript:void(0)" class="text-muted"><i class="ri-question-answer-line align-bottom"></i> 19
                                                    </BLink>
                                                </li>
                                                <li class="list-inline-item">
                                                    <BLink href="javascript:void(0)" class="text-muted"><i class="ri-attachment-2 align-bottom"></i> 02</BLink>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
            ...
            <div class="tasks-list">
                <div class="d-flex mb-3">
                    <div class="flex-grow-1">
                        <h6 class="fs-14 text-uppercase fw-semibold mb-0">To Do <BBadge tag="small" variant="secondary" class="align-bottom ms-1">2</BBadge>
                        </h6>
                    </div>
                    <div class="flex-shrink-0">
                        <BDropdown variant="link" class="card-header-dropdown" toggle-class="p-0 arrow-none" menu-class="dropdown-menu-end" :offset="{ alignmentAxis: -70, crossAxis: 0, mainAxis: 10 }">
                        ...
                        <draggable :list="inprogress" class="dragArea" group="reviews">
                            <BCard no-body class="tasks-box" v-for="(data, index) of inprogress" :key="index">
                                <BCardBody>
                                    <div class="d-flex mb-2">
                                        <h6 class="fs-15 mb-0 flex-grow-1 text-truncate">
                                            <Link href="/apps/tasks-details" class="text-reset">{{ data.title }}</Link>
                                        </h6>
                                        <BDropdown variant="link" toggle-class="text-muted p-0 arrow-none" :offset="{ alignmentAxis: -130, crossAxis: 0, mainAxis: 10 }">
                                            <template #button-content><i class="ri-more-fill "></i></template>
                                            <Link class="dropdown-item" href="/apps/tasks-details"><i class="ri-eye-fill align-bottom me-2 text-muted"></i>
            ...
            <div class="tasks-list">
                <div class="d-flex mb-3">
                    <div class="flex-grow-1">
                        <h6 class="fs-14 text-uppercase fw-semibold mb-0">new <BBadge tag="small" variant="success" class="align-bottom ms-1">1</BBadge>
                        </h6>
                    </div>
                    <div class="flex-shrink-0">
                        <BDropdown variant="link" class="card-header-dropdown" toggle-class="p-0 arrow-none" menu-class="dropdown-menu-end" :offset="{ alignmentAxis: -70, crossAxis: 0, mainAxis: 10 }">
        ...
        <BModal v-model="modalShow" header-class="p-3 bg-warning-subtle" content-class="border-0" hide-footer title="Add Member" class="v-modal-custom">
            <b-form>
                <BRow class="g-3">
                    <BCol lg="12">
            ...
            <div class="modal-footer v-modal-footer">
                <BButton type="button" variant="light" @click="modalShow = false"><i class="ri-close-line align-bottom me-1"></i> Close</BButton>
                <BButton type="button" variant="success" id="addMember">Add Member</BButton>
            </div>
        </BModal>

        <BModal v-model="modalShow1" header-class="p-3 bg-info-subtle" content-class="border-0" hide-footer title="Add Board" class="v-modal-custom" centered>
            <b-form action="#">
                <BRow>
                    <BCol lg="12">
        ...
        <BModal v-model="modalShow2" header-class="p-3 bg-info-subtle" content-class="border-0" hide-footer title="Create New Task" class="v-modal-custom" size="lg" centered>
            <b-form action="#">
                <BRow class="g-3">
                    <BCol lg="12">
        ...
        <BModal v-model="modalShow3" id="deleteTask" modal-class="zoomIn" hide-footer class="v-modal-custom" centered>
            <div class="mt-2 text-center">
                <lottie class="avatar-xl" colors="primary:#f7b84b,secondary:#f06548" :options="defaultOptions" :height="100" :width="100" />
