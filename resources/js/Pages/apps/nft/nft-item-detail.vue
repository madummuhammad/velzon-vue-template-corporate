                ...
                <BRow class="g-4">
                    ...
                    <BCol lg="8">
                        <div>
                            ...
                            <BBadge variant="info-subtle" class="bg-secondary-subtle text-secondary mb-3 fs-12"><i
                                    class="ri-eye-line me-1 align-bottom"></i>
                                8,634 people views this</BBadge>
                            <h4>Patterns Arts & Culture</h4>
                            <div class="hstack gap-3 flex-wrap">
                                <div class="text-muted">Creators : <BLink href="#" class="text-primary fw-medium">Nancy
                                        Martino</BLink>
                                </div>
                                <div class="vr"></div>
