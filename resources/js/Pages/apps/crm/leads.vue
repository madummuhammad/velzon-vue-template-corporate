            ...
            <BRow class="g-4 align-items-center">
              ...
              <BCol sm="auto" class="ms-auto">
                <div class="hstack gap-2">
                  ...
                  <BButton @click="rightOffcanvas = true" type="button" variant="primary" href="#offcanvasExample">
                  ...
                  <BDropdown variant="link" class="card-header-dropdown" toggle-class="btn btn-soft-info btn-icon fs-14 arrow-none" menu-class="dropdown-menu-end">
