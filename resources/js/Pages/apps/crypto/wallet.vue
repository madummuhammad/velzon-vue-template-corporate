                  ...
                  <tr v-for="(data, index) of resultQuery" :key="index">
                    ...
                    <td>
                      <div class="d-flex align-items-center fw-medium">
                        ...
                        <BLink href="javascript:void(0)" class="currency_name text-reset">{{ data.currency_name }}</BLink>
                      </div>
                    </td>
                    ...
                    <td class="returns_per">
                      <h6 class="fs-13 mb-0" :class="{ 'text-danger': data.volume > 1, 'text-success': data.volume < 1 }">
