          ...
          <BCardBody>
            <div class="d-flex mb-3">
              <div class="flex-grow-1">
                <lottie colors="primary:#121331,secondary:#08a88a" :options="defaultOptions" :height="55" :width="55" class="me-auto m-0" />
              </div>
            ...
            <h4 class="mb-2">
              $ <count-to :duration="5000" :startVal="0" :endVal="74854"></count-to><small class="text-muted fs-13">.68k</small>
            </h4>
      ...
      <BCol xxl="3" md="6">
        <BCard no-body class="card-animate">
          <BCardBody>
            <div class="d-flex mb-3">
              <div class="flex-grow-1">
                <lottie colors="primary:#405189,secondary:#0ab39c" :options="defaultOptions1" :height="55" :width="55" class="me-auto m-0" />
              </div>
              <div class="flex-shrink-0">
                <BLink href="javascript:void(0);" class="badge bg-warning-subtle text-warning badge-border me-1">BTC
                </BLink>
            ...
            <h4 class="mb-2">
              $<count-to :duration="5000" :startVal="0" :endVal="74361"></count-to><small class="text-muted fs-13">.34k</small>
            </h4>
      ...
      <BCol xxl="3" md="6">
        <BCard no-body class="card-animate">
          <BCardBody>
            <div class="d-flex mb-3">
              <div class="flex-grow-1">
                <lottie colors="primary:#405189,secondary:#0ab39c" :options="defaultOptions3" :height="55" :width="55" class="me-auto m-0" />
              </div>
              <div class="flex-shrink-0">
                <BLink href="javascript:void(0);" class="badge bg-warning-subtle text-warning badge-border me-1">BTC
                </BLink>
            ...
            <h4 class="mb-2">
              $<count-to :duration="5000" :startVal="0" :endVal="97685"></count-to><small class="text-muted fs-13">.22k</small>
            </h4>
          ...
          <swiper-slide>
            <BCard no-body class="card-animate overflow-hidden">
              <BCardBody class="bg-warning-subtle">
                <div class="d-flex mb-3">
                  <div class="flex-grow-1">
                    <lottie colors="primary:#405189,secondary:#0ab39c" :options="defaultOptions4" :height="55" :width="55" class="me-auto m-0" />
                  </div>
                  <div class="flex-shrink-0">
          ...
          <table class="table align-middle table-nowrap" id="customerTable">
            ...
            <tbody class="list form-check-all">
              <tr v-for="(data, index) of resultQuery" :key="index">
                ...
                <td>
                  <div class="avatar-xs">
                    <div class="avatar-title rounded-circle fs-16" :class="{ 'text-success bg-success-subtle': data.icon == 'ri-arrow-left-down-fill', 'bg-danger-subtle text-danger': data.icon == 'ri-arrow-right-up-fill' }">
                      <i :class="data.icon"></i>
                    </div>
                  </div>
                </td>
                ...
                <td>
                  <h6 class="mb-1 amount" :class="{ 'text-success': data.icon == 'ri-arrow-left-down-fill', 'text-danger': data.icon == 'ri-arrow-right-up-fill' }">
                    {{ data.amount }}
                  </h6>
                  <p class="text-muted mb-0">{{ data.amount1 }}</p>
                </td>
                <td class="status">
                  <span class="badge fs-11" :class="{ 'bg-success-subtle text-success': data.status == 'Success', 'bg-danger-subtle text-danger': data.status == 'Failed', 'bg-warning-subtle text-warning': data.status == 'Processing', }">
