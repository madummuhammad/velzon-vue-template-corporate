...
<template>
  <Layout>
    ...
    <BModal v-model="modalShow" body-class="p-0" header-class="p-3" title-class="text-uppercase" hide-footer title="Verify your Account" class="v-modal-custom" size="lg" centered>
          ...
          <BTabs v-model="tabIndex" nav-class="nav-pills nav-justified custom-nav">
              ...
              <BRow>
                ...
                <BCol lg="12">
                  <div class="hstack align-items-start gap-3 mt-4">
                    <BButton variant="light" type="button" class="btn-label previestab" @click="tabIndex--">
            ...
            <BTab class="nav-item p-3">
              ...
              <BRow class="text-center justify-content-center">
                <BCol lg="11">
                  <div class="mb-4">
                    <lottie colors="primary:#687cfe,secondary:#ff7f5d" :options="defaultOptions" :height="120" :width="120" />
                  </div>
                  ...
                  <div class="hstack justify-content-center gap-2">
                    ...
                    <BButton type="button" variant="secondary" @click="tabIndex = 0">
