              ...
              <table class="table align-middle table-nowrap" id="customerTable">
                ...
                <tbody class="list form-check-all">
                  <tr v-for="(data, index) of resultQuery" :key="index">
                    ...
                    <td class="status">
                      <span :class="{ 'badge bg-success-subtle text-success text-uppercase': data.status == 'Successful', 'badge bg-danger-subtle text-danger text-uppercase': data.status == 'Cancelled', 'badge bg-warning-subtle text-warning text-uppercase': data.status == 'Pending' }">{{ data.status }}</span>
                    </td>
                  </tr>
                </tbody>
              </table>
