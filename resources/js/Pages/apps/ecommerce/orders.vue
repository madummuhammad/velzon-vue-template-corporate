...
<template>
  <Layout>
              ...
              <BRow class="g-3">
                <BCol xxl="5" sm="6">
                  <div class="search-box">
                    <input type="text" class="form-control search" v-model="searchQuery" placeholder="Search for order ID, customer, order status or something..." />
                    <i class="ri-search-line search-icon"></i>
                  </div>
                </BCol>
                <BCol xxl="2" sm="6">
                  <div>
                    <flat-pickr placeholder="Select date" v-model="date2" :config="config" class="form-control flatpickr-input" id="demo-datepicker"></flat-pickr>
                  </div>
                </BCol>
                <BCol xxl="2" sm="4">
                  <div>
                    <Multiselect class="form-control" v-model="status1" :close-on-select="true" :searchable="true" :create-option="true" @input="onChangePayment" :options="[
                      { value: '', label: 'Status' },
                      { value: 'All', label: 'All' },
                ...
                <BCol xxl="2" sm="4">
                  <div>
                    <Multiselect class="form-control" v-model="value1" :close-on-select="true" :searchable="true" :create-option="true" @input="onChangeStatus" :options="[
          ...
          <BCardBody class="pt-0">
            <div>
              <ul class="nav nav-tabs nav-tabs-custom nav-success mb-3" role="tablist">
                <li class="nav-item">
                  <BLink class="nav-link  All py-3 active" data-bs-toggle="tab" id="All" href="#home1" role="tab" @click="changecategory('All')" aria-selected="true">
                    <i class="ri-store-2-fill me-1 align-bottom"></i> All Orders
                  </BLink>
                </li>
                <li class="nav-item">
                  <BLink class="nav-link py-3  Delivered" data-bs-toggle="tab" id="Delivered" href="#delivered" role="tab" @click="changecategory('Delivered')" aria-selected="false">
                    <i class="ri-checkbox-circle-line me-1 align-bottom"></i>
                    Delivered
                  </BLink>
                </li>
                <li class="nav-item">
                  <BLink class="nav-link py-3 Pickups" data-bs-toggle="tab" id="Pickups" href="#pickups" role="tab" @click="changecategory('Pickups')" aria-selected="false">
                    <i class="ri-truck-line me-1 align-bottom"></i> Pickups
                    <BBadge variant="danger" class="align-middle ms-1">2</BBadge>
                  </BLink>
                </li>
                <li class="nav-item">
                  <BLink class="nav-link py-3 Returns" data-bs-toggle="tab" id="Returns" href="#returns" role="tab" @click="changecategory('Returns')" aria-selected="false">
                    <i class="ri-arrow-left-right-fill me-1 align-bottom"></i>
                    Returns
                  </BLink>
                </li>
                <li class="nav-item">
                  <BLink class="nav-link py-3 Cancelled" data-bs-toggle="tab" id="Cancelled" href="#cancelled" role="tab" @click="changecategory('Cancelled')" aria-selected="false">
    ...
    <!-- order modal -->
    <BModal v-model="createModal" hide-footer :title="dataEdit ? 'Edit Order' : 'Add Order'" header-class="p-3 bg-light" class="v-modal-custom" centered>
      <b-form action="#" id="addform" class="tablelist-form" autocomplete="off">
        ...
        <div class="mb-3">
          ...
          <select class="form-control" data-trigger name="productname-field" id="productname" v-model="event.product" :class="{ 'is-invalid': submitted && !event.product }">
        ...
        <div class="mb-3">
          ...
          <flat-pickr placeholder="Select date" :config="timeConfig" v-model="event.orderDate" :class="{ 'is-invalid': submitted && !event.orderDate }" class="form-control flatpickr-input" id="orderdate"></flat-pickr>
        ...
        <BRow class="gy-4 mb-3">
          <BCol md="6">
            <div>
              ...
              <input type="text" id="amount" class="form-control" placeholder="Total amount" v-model="event.amount" :class="{ 'is-invalid': submitted && !event.amount }" />
          ...
          <BCol md="6">
            <div>
              ...
              <select class="form-control" data-trigger name="payment-method" id="payment" v-model="event.payment" :class="{ 'is-invalid': submitted && !event.payment }">
        ...
        <div class="mb-3">
          ...
          <select class="form-control" data-trigger name="delivered-status" id="delivered" v-model="event.status" :class="{ 'is-invalid': submitted && !event.status }">
