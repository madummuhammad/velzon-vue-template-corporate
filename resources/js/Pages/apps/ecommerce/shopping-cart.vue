...
<template>
  <Layout>
    ...
    <BRow class="mb-3">
      <BCol xl="8">
            ...
            <BRow class="align-items-center gy-3">
              <BCol sm>
                <div class="d-flex flex-wrap my-n1">
                  ...
                  <div>
                    <BLink href="#" class="d-block text-body p-1 px-2"><i class="ri-star-fill text-muted align-bottom me-1"></i>
                      Add Wishlist</BLink>
                  </div>
                </div>
              </BCol>
        ...
        <div class="text-end mb-4">
          <Link href="/ecommerce/checkout" class="btn btn-secondary btn-label right ms-auto"><i class="ri-arrow-right-line label-icon align-bottom fs-16 ms-2"></i>
          Checkout</Link>
        </div>
      </BCol>
        ...
        <div class="sticky-side-div">
          ...
          <BAlert variant="danger" :model-value="true" class="border-dashed" role="alert" show>
            <div class="d-flex align-items-center">
              <lottie variant="danger" :options="defaultOptions" :height="80" :width="80" style="margin:0px;" />
              <div class="ms-2">
    ...
    <!-- edit customer modal  -->
    <BModal v-model="removeItemModal" id="removeItemModal" modal-class="zoomIn" hide-footer title="Update Customer" class="v-modal-custom" centered no-close-on-backdrop>
