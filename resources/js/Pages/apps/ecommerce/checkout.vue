          ...
          <BCardBody class="checkout-tab">
            <BForm action="#">
              <div class="step-arrow-nav mt-n3 mx-n3 mb-3">
                <BTabs v-model="tabIndex" nav-class="nav-pills nav-justified custom-nav">
                  <BTab active class="nav-item nav-link p-3">
                    <template #title>
                      <div class="fs-15">
                        <i class="ri-user-2-line fs-16 avatar-xs d-inline-flex align-items-center justify-content-center bg-primary-subtle text-primary rounded-circle align-middle me-2"></i>
                        Personal Info
                      </div>
                    </template>
                    <div>
                    ...
                    <div>
                      ...
                      <div class="d-flex align-items-start gap-3 mt-3">
                        <BButton variant="secondary" type="button" class="btn-label right ms-auto nexttab" @click="tabIndex++">
                  ...
                  <BTab class="nav-item nav-link fs-15 p-3">
                    <template #title>
                      <div class="fs-15">
                        <i class="ri-truck-line fs-16 avatar-xs d-inline-flex align-items-center justify-content-center bg-primary-subtle text-primary rounded-circle align-middle me-2"></i>
                        Shipping Info
                      </div>
                    </template>
                    <div>
                    ...
                    <div class="d-flex align-items-start gap-3 mt-4">
                      <BButton type="button" variant="light" class="btn-label previestab" @click="tabIndex--">
                        <i class="ri-arrow-left-line label-icon align-middle fs-16 me-2"></i>Back to Personal Info
                      </BButton>
                      <BButton type="button" variant="secondary" class="btn-label right ms-auto nexttab" @click="tabIndex++">
                        <i class="ri-bank-card-line label-icon align-middle fs-16 ms-2"></i>Continue to Payment
                      </BButton>
                    </div>
                  </BTab>
                  ...
                  <BTab class="nav-item nav-link fs-15 p-3">
                    <template #title>
                      <div class="fs-15">
                        <i class="ri-bank-card-line fs-16 avatar-xs d-inline-flex align-items-center justify-content-center bg-primary-subtle text-primary rounded-circle align-middle me-2"></i>
                        Payment Info
                      </div>
                    </template>
                    <div>
                  ...
                  <BTab class="nav-item nav-link fs-15 p-3">
                    <template #title>
                      <div class="fs-15">
                        <i class="ri-checkbox-circle-line fs-16 avatar-xs d-inline-flex align-items-center justify-content-center bg-primary-subtle 
                          text-primary rounded-circle align-middle me-2"></i>
                        Finish
                      </div>
                    </template>
