    ...
    <BRow>
      ...
      <BCol xxl="9">
        ...
        <BRow class="g-4 mb-3">
          <BCol sm="auto">
            <div>
              <Link href="/ecommerce/add-product" class="btn btn-secondary"><i
                    ...
                    <td data-column-id="action" class="gridjs-td">
                      <span>
                        <BDropdown variant="link" toggle-class="btn btn-soft-secondary btn-sm dropdown arrow-none"
                          ...
                          <Link class="dropdown-item" href="/ecommerce/product-details"> <i
                              class="ri-eye-fill align-bottom me-2 text-muted"></i>
                            View</Link>
                          <Link class="dropdown-item" href="/ecommerce/add-product"><i
