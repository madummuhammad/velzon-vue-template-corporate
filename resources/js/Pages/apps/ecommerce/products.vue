    ...
    deletedata(event) {
      Swal.fire({
        ...
        if (result.value) {
          ...
          var newData = this.productsData;
          this.productsData = newData.filter(function (product) {
            return event.id != product.id;
          });
        ...
        <BCard no-body>
          <BCardHeader>
            ...
            <div class="filter-choices-input">
              <Multiselect v-model="value" mode="tags" :close-on-select="true" :searchable="true" :create-option="true" :options="[
          ...
          <div class="accordion accordion-flush">
            ...
            <div class="accordion-item">
              <h2 class="accordion-header" id="flush-headingDiscount">
                <button class="accordion-button bg-transparent shadow-none collapsed" type="button" v-b-toggle.flush-collapseDiscount>
            ...
            <div class="accordion-item">
              <h2 class="accordion-header" id="flush-headingRating">
                <button class="accordion-button bg-transparent shadow-none collapsed" type="button" v-b-toggle.flush-collapseRating>
                  ...
                  <ul class="nav nav-tabs-custom card-header-tabs border-bottom-0" role="tablist">
                    <li class="nav-item">
                      <BLink class="nav-link active fw-semibold" data-bs-toggle="tab" href="#productnav-all" role="tab">
                        All
                        <BBadge variant="danger-subtle" class="bg-danger-subtle text-danger align-middle rounded-pill ms-1">12</BBadge>
                      </BLink>
                    </li>
                  </ul>
                </BCol>
                      ...
                      <tbody class="list form-check-all">
                        <tr class="gridjs-tr" v-for="(data, index) of resultQuery" :key="index">
                          ...
                          <td data-column-id="rating" class="gridjs-td">
                            <span>
                              <BBadge class="bg-light text-body fs-12 fw-medium"><i class="mdi mdi-star text-warning me-1"></i>{{ data.rating }}</BBadge>
                            </span>
                          </td>
                          <td data-column-id="published" class="gridjs-td">
                            <span>{{ data.publishedDate
                            }}<small class="text-muted ms-1">{{ data.publishedtime }}</small></span>
                          </td>
                            ...
                            <span>
                              <div class="dropdown">
                                <BDropdown variant="link" toggle-class="btn btn-soft-secondary btn-sm dropdown arrow-none" menu-class="dropdown-menu-end" :offset="{ alignmentAxis: -130, crossAxis: 0, mainAxis: 10 }">
                                  ...
                                  <Link class="dropdown-item" href="/ecommerce/product-details"><i class="ri-eye-fill align-bottom me-2 text-muted"></i>
                                  View</Link>
                                  <Link class="dropdown-item" href="/ecommerce/add-product"> <i class="ri-pencil-fill align-bottom me-2 text-muted"></i>
                                  Edit
                                  </Link>
                    ...
                    <div class="d-flex justify-content-end m-3">
                      <div class="pagination-wrap hstack gap-2">
                        ...
                        <ul class="pagination listjs-pagination mb-0">
                          <li v-for="(pageNumber, index) in pages" :key="index" @click="page = pageNumber" :class="{ active: pageNumber == page, disabled: pageNumber == '...', }">
