        ...
        <div class="email-wrapper d-lg-flex gap-1 mx-n4 mt-n4 p-1">
            <div class="email-menu-sidebar" id="menusidebar">
                <div class="p-4 d-flex flex-column h-100">
                    ...
                    <simplebar class="mx-n4 px-4 email-menu-sidebar-scroll">
                        <div class="mail-list mt-3">
                            <BLink href="#" class="active" @click="changemenu('all')"><i class="ri-mail-fill me-3 align-middle fw-medium"></i>
            ...
            <div class="email-content">
                <div class="px-4 pt-4 pb-0">
                    ...
                    <div class="message-list-content mx-n4 px-4 message-list-scroll" id="emailsdatas">
                        <div id="elmLoader">
