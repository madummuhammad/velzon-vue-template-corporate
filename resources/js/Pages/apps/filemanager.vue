...
<template>
  <Layout>
    ...
    <div class="chat-wrapper d-lg-flex gap-1 mx-n4 mt-n4 p-1">
      <div class="file-manager-sidebar">
        <div class="p-3 d-flex flex-column h-100">
          ...
          <simplebar class="mt-3 mx-n4 px-4 file-menu-sidebar-scroll">
      ...
      <div class="file-manager-content w-100 p-3 py-0">
        <simplebar class="mx-n3 pt-4 px-4 file-manager-content-scroll">
            ...
            <BRow class="justify-content-beetwen g-2 mb-3">
              ...
              <BCol cols="auto">
                <div class="d-flex gap-2 align-items-start mb-2">
                  ...
                  <BButton variant="success" class="create-folder-modal text-nowrap flex-shrink-0" @click="openFolderModal"><i class="ri-add-line align-bottom me-1"></i> Create Folders
                  </BButton>
                </div>
              </BCol>
                  ...
                  <BCardBody>
                    <div class="d-flex mb-1">
                      <div class="form-check form-check-danger mb-3 fs-15 flex-grow-1">
                        <input class="form-check-input" type="checkbox" value="" id="folderlistCheckbox_1" checked v-if="folder.ischecked" />
                        <input class="form-check-input" type="checkbox" value="" id="folderlistCheckbox_1" v-if="!folder.ischecked" />
                        <label class="form-check-label" for="folderlistCheckbox_1"></label>
                      </div>
                      <BDropdown variant="ghost-primary" size="sm" class="btn-icon" toggle-class="arrow-none" menu-class="dropdown-menu-end" :offset="{ alignmentAxis: -125, crossAxis: 0, mainAxis: 0 }">
          ...
          <div>
            <div class="d-flex align-items-center mb-3">
              ...
              <div class="flex-shrink-0">
                <BButton variant="success" class="create-folder-modal text-nowrap flex-shrink-0" @click="openFileModal"><i class="ri-add-line align-bottom me-1"></i> Create File</BButton>
              </div>
            </div>
                  ...
                  <tr v-for="(fileData, index) of this.filelist" :key="index">
                      ...
                      <div class="d-flex align-items-center">
                        <div class="flex-shrink-0 fs-17 me-2 filelist-icon">
                          ...
                          <i class="ri-file-text-fill align-bottom text-secondary" v-if="fileData.fileName.includes('.') &&
                            ...
                            "></i>
                          <i class="ri-file-text-fill align-bottom text-secondary" v-if="!fileData.fileName.includes('.')"></i>
                        </div>
                    ...
                    <td>
                      <div class="d-flex gap-3 justify-content-center">
                        <button type="button" class="btn btn-ghost-primary btn-icon btn-sm favourite-btn active" v-if="fileData.starred" @click="togglefavorite">
                          <i class="ri-star-fill fs-13 align-bottom"></i>
                        </button>
                        <button type="button" class="btn btn-ghost-primary btn-icon btn-sm favourite-btn" v-if="!fileData.starred">
                          <i class="ri-star-fill fs-13 align-bottom"></i>
                        </button>

                        <BDropdown variant="light" size="sm" class="btn-icon" toggle-class="arrow-none" menu-class="dropdown-menu-end">
                          <template #button-content>
      ...
      <div class="file-manager-detail-content p-3 py-0">
        <simplebar class="mx-n3 pt-3 px-3 file-detail-content-scroll">
          <div id="folder-overview">
            <div class="d-flex align-items-center pb-3 border-bottom border-bottom-dashed">
              ...
              <div>
                <BButton type="button" variant="soft-danger" size="sm" class="btn-icon fs-16 close-btn-overview" @click="closeSidepanel">
    ...
    <BModal v-model="folderModal" hide-footer title="Create Folder" title-class="exampleModalLabelFolder" class="v-modal-custom" modal-class="zoomIn" centered header-class="p-3 bg-success-subtle">
      <BForm autocomplete="off" class="needs-validation createfolder-form" id="createfolder-form" novalidate>
        ...
        <div class="hstack gap-2 justify-content-end">
          <BButton type="button" variant="ghost-success" data-bs-dismiss="modal" id="addFolderBtn-close" @click="folderModal = false">
    ...
    <BModal v-model="fileModal" hide-footer title="Create File" title-class="exampleModalLabel" class="v-modal-custom" modal-class="zoomIn" centered header-class="p-3 bg-success-subtle">
