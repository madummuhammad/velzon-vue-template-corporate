  ...
  <BCard no-body class="card-height-100">
    <BCardHeader class="align-items-center d-flex py-0">
      ...
      <div class="flex-shrink-0">
        <BDropdown variant="link" class="card-header-dropdown" toggle-class="text-reset dropdown-btn arrow-none" menu-class="dropdown-menu-end" aria-haspopup="true" :offset="{ alignmentAxis: -5, crossAxis: 0, mainAxis: 0 }">
          <template #button-content> <span class="fw-semibold text-uppercase fs-12">Sort by: </span><span class="text-muted">Last 30 Days<i class="mdi mdi-chevron-down ms-1"></i></span>
          </template>
        ...
        <table class="table table-borderless table-nowrap align-middle mb-0">
          ...
          <tbody>
            <tr v-for="(item, index) of teamMembers" :key="index">
              ...
              <td style="width: 5%">
                <apexchart class="apex-charts" height="36" dir="ltr" :series="item.series" :options="{ ...chartOptions, ...{ colors: [item.chartsColor] } }"></apexchart>
              </td>
            </tr>
          </tbody>
        </table>
