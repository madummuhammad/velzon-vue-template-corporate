    ...
    <BCard no-body class="card-height-100">
        <BCardHeader class="align-items-center d-flex py-0">
            ...
            <div class="flex-shrink-0">
                <BDropdown variant="link" class="card-header-dropdown" toggle-class="text-reset dropdown-btn arrow-none" menu-class="dropdown-menu-end" aria-haspopup="true" :offset="{ alignmentAxis: -75, crossAxis: 0, mainAxis: 0 }">
                    <template #button-content><span class="text-muted"><i class="ri-settings-4-line align-bottom me-1"></i>Setting <i class="mdi mdi-chevron-down ms-1"></i></span>
                    </template>
        ...
        <BCardBody class="p-0">
            <div id="users-chat">
                <simplebar class="chat-conversation p-3" id="chat-conversation" style="height: 400px;">
                            ...
                            <div class="conversation-list">
                                ...
                                <div class="user-chat-content">
                                    <div class="ctext-wrap">
                                        ...
                                        <BDropdown variant="link" class="card-header-dropdown align-self-start message-box-drop" toggle-class="text-reset dropdown-btn arrow-none" menu-class="dropdown-menu" aria-haspopup="true">
                                    ...
                                    <div class="ctext-wrap">
                                        <div class="message-img mb-0">
                                            <div class="message-img-list">
                                                <div>
                                                    <BLink class="popup-img d-inline-block" href="javascript:void(0)">
                                                ...
                                                <div class="message-img-link">
                                                    <ul class="list-inline mb-0">
                                                        <li class="list-inline-item dropdown">
                                                            <BLink class="dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                <i class="ri-more-fill"></i>
                                                            </BLink>
                                                            <div class="dropdown-menu">
                                                                <BLink class="dropdown-item" href="@assets/images/small/img-1.jpg" download="">
                                                                    <i class="ri-download-2-line me-2 text-muted align-bottom"></i>Download
                                                                </BLink>
                                                                <BLink class="dropdown-item" href="#"><i class="ri-reply-line me-2 text-muted align-bottom"></i>Reply
                                                                </BLink>
                                                                <BLink class="dropdown-item" href="#"><i class="ri-share-line me-2 text-muted align-bottom"></i>Forward
                                                                </BLink>
                                                                <BLink class="dropdown-item" href="#"><i class="ri-bookmark-line me-2 text-muted align-bottom"></i>Bookmark
                                                                </BLink>
                                                                <BLink class="dropdown-item delete-item" href="#"><i class="ri-delete-bin-5-line me-2 text-muted align-bottom"></i>Delete
                                                                </BLink>
                                                            </div>
                                                        </li>
                                                    </ul>
                                                ...
                                                <div class="message-img-link">
                                                    <ul class="list-inline mb-0">
                                                        <li class="list-inline-item dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <BLink class="dropdown-item" href="javascript:void(0)" download="">
                                                                    <i class="ri-download-2-line me-2 text-muted align-bottom"></i>Download
                                                                </BLink>
                                                                <BLink class="dropdown-item" href="#"><i class="ri-reply-line me-2 text-muted align-bottom"></i>Reply
                                                                </BLink>
