                  ...
                  <div class="table-responsive table-card">
                    <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                      ...
                      <tbody>
                        <tr>
                          <td>
                            <Link href="/ecommerce/order-details" class="fw-medium text-reset">#VZ2112
                            </Link>
                          </td>
                          <td>
                            <div class="d-flex align-items-center">
                        ...
                        <tr>
                          <td>
                            <Link href="/ecommerce/order-details" class="fw-medium text-reset">#VZ2111
                            </Link>
                          </td>
                          <td>
                            <div class="d-flex align-items-center">
                        ...
                        <tr>
                          <td>
                            <Link href="/ecommerce/order-details" class="fw-medium text-reset">#VZ2109
                            </Link>
                          </td>
                          <td>
                            <div class="d-flex align-items-center">
                        ...
                        <tr>
                          <td>
                            <Link href="/ecommerce/order-details" class="fw-medium text-reset">#VZ2108
                            </Link>
                          </td>
                          <td>
                            <div class="d-flex align-items-center">
                        ...
                        <tr>
                          <td>
                            <Link href="/ecommerce/order-details" class="fw-medium text-reset">#VZ2107
                            </Link>
                          </td>
                          <td>
                            <div class="d-flex align-items-center">
